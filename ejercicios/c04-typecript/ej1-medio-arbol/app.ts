...
const btn = document.getElementById("buttonGenerar")! as HTMLButtonElement;
const input = document.getElementById("idalta")! as HTMLInputElement;
const Pantalla_resultado = document.getElementById("resultado")! as HTMLPreElement;

function generarMedioArbol(n: number): string {
